...
# fourcc = cv2.VideoWriter_fourcc(*'mp4v')  # Use 'avc1' or 'mp4v' for MP4
...
# #         draw_box(current_frame, bbox)

# #         if second == 1:
# #             boxes_xyxy = first_inference(current_frame)
# #             person_feature = osnet_x1_model_output(current_frame, boxes_xyxy)
# #             index = select_person(current_frame, boxes_xyxy)
# #             track_feature = person_feature[index]
# #         else:
# #             boxes_xyxy = detr_model_output(current_frame, bbox)
# #             person_feature = osnet_x1_model_output(current_frame, boxes_xyxy)
# #             if person_feature is not None:
# #                 track_feature = mark_person(updated_embedding, person_feature)
